export const PER_PAGE_FIRST = 4; // No of posts to be shown on first page.
export const PER_PAGE_REST = 6; // No of posts to be shown following page and after.
 ...
 */
export const createPaginationLinks = ( currentPage: number, totalPages: number ) => {
